  ...
  return <div className="relative bg-gradient-to-r from-primary to-secondary px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3 flex-1 min-w-[250px]">
          <Sparkles className="h-6 w-6 text-foreground shrink-0" />
        ...
        <div className="flex items-center gap-3">
          <Button onClick={handleStartTrial} size="sm" className="bg-foreground text-background hover:bg-foreground/90 font-semibold">
            Start Free Trial
          </Button>
